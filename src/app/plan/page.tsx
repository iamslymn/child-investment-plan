...
export default function PlanPage() {
  ...
  const updatePlan = (updates: Partial<PlanData>) => {
    setPlan((prev) => {
      ...
      // Auto-calculate duration when child age changes
      ...
      <div className="pt-24 pb-12 max-w-3xl mx-auto px-4 sm:px-6">
        ...
        <div className="mb-8">
            ...
            {stepTitles.map((title, i) => (
              <div
                ...
                className={`flex items-center gap-2 text-sm font-medium ${
                  i + 1 <= step ? "text-[#6366f1]" : "text-[#94a3b8]"
                }`}
              >
                <div
                  className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold ${
                    i + 1 < step
                      ...
                      : i + 1 === step
                      ? "bg-[#6366f1]/10 text-[#6366f1] ring-2 ring-[#6366f1]"
          ...
          <div className="w-full bg-[#e2e8f0] rounded-full h-2">
            <div
              className="bg-gradient-to-r from-[#6366f1] to-[#06b6d4] h-2 rounded-full transition-all duration-500"
                ...
                <div className="space-y-8">
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-xs text-[#94a3b8]">
                      Uşaq {plan.childAge + plan.planDuration} yaşına çatana
                      qədər
                    </p>
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-3 gap-4 mt-4">
                    ...
                    <div className="text-center p-3 bg-[#f1f5f9] rounded-xl">
                      ...
                      <p className="text-lg font-bold text-[#10b981]">
                        $
                        {(
                          calculateFinalValue(plan) -
                          calculateTotalInvested(plan)
                        ).toLocaleString()}
                      </p>
                    </div>
                  </div>
              ...
              <div className="bg-white rounded-3xl p-8 shadow-sm border border-[#e2e8f0]">
                <div className="flex items-center gap-3 mb-8">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#64748b]">
                      Uşağınızın gələcəyini hər şəraitdə təmin edin
                    </p>
                  </div>
                </div>

                {/* Main insurance card */}
                <div className="bg-gradient-to-br from-[#6366f1] to-[#4f46e5] rounded-2xl p-8 text-white mb-8">
                  <div className="flex items-center gap-3 mb-6">
                    <Shield className="w-8 h-8" />
                    <h3 className="text-xl font-bold">
                      Həyat Sığortası Planı
                    </h3>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                      ...
                      <p className="text-3xl font-bold">
                        $
                        {calculateInsuranceCoverage(plan).toLocaleString()}
                      </p>
                    </div>
                    <div>
                      <p className="text-white/70 text-sm mb-1">
                      ...
                      <p className="text-3xl font-bold">
                        ${calculateInsurancePremium(plan).toLocaleString()}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-4 p-4 bg-[#f0fdf4] rounded-xl border border-[#bbf7d0]">
                    ...
                    <div>
                      <h4 className="font-semibold text-[#0f172a]">
                        Valideyn vəfat edərsə plan davam edəcək
                      </h4>
                      <p className="text-sm text-[#64748b] mt-1">
                        Sığorta şirkəti qalan investisiya haqlarını ödəyəcək
                        və plan müddəti bitənə qədər davam edəcək.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4 p-4 bg-[#eff6ff] rounded-xl border border-[#bfdbfe]">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-[#64748b] mt-1">
                        Proqnozlaşdırılan dəyərin 120%-i qədər sığorta
                        təminatı ilə uşağınız tam qorunur.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4 p-4 bg-[#fefce8] rounded-xl border border-[#fde68a]">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-[#64748b] mt-1">
                        Sığorta premium məbləği investisiya haqlarına əlavə
                        olaraq tutulur. Real premium məbləğ sığorta
                        müqaviləsinə əsasən dəyişə bilər.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-white rounded-3xl p-8 shadow-sm border border-[#e2e8f0]">
                <div className="flex items-center gap-3 mb-8">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#64748b]">
                      Planınızı yoxlayın və təsdiqləyin
                    </p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                  ...
                  <div className="p-5 bg-[#f8fafc] rounded-2xl border border-[#e2e8f0]">
                    ...
                    <p
                      ...
                      style={{ color: RISK_COLORS[plan.riskLevel] }}
                    >
                  ...
                  <div className="p-5 bg-[#f8fafc] rounded-2xl border border-[#e2e8f0]">
                    ...
                    <p className="text-xl font-bold text-[#6366f1]">
                      ${calculateInsurancePremium(plan)}
                    </p>
                  </div>
                </div>

                {/* Key Numbers */}
                <div className="bg-gradient-to-r from-[#6366f1] to-[#06b6d4] rounded-2xl p-6 text-white mb-6">
        ...
        <div className="flex items-center justify-between mt-8">
          ...
          {step < totalSteps ? (
            <button
              onClick={nextStep}
              className="flex items-center gap-2 px-8 py-3 rounded-xl bg-[#6366f1] text-white font-medium hover:bg-[#4f46e5] shadow-lg shadow-[#6366f1]/25 transition-all"
            >
              Davam et
            ...
            <button
              ...
              className="flex items-center gap-2 px-8 py-3 rounded-xl bg-gradient-to-r from-[#10b981] to-[#059669] text-white font-medium hover:shadow-lg hover:shadow-[#10b981]/25 transition-all"
            >
              <CheckCircle2 className="w-5 h-5" />
              Planı Təsdiqlə
            </button>
